...
array.map((number, index) => number * 2 ) // Returns [2, 4, 6]
...
array.sort() // Sorts alphabetically
array.sort((a, b) => a - b) // sorts numerical ascending
array.sort((a, b) -> b - a ) // sorts numerical descending
